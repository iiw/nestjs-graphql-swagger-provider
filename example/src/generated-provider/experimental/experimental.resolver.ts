...
export class ExperimentalResolver {
  ...
  async signMetadata(@Args('walletId') walletId: string, @Args('input') input: PostWalletsWalletIdSignaturesRoleIndexInput, @Args('role', { type: () => SignMetadataRole, nullable: true }) role?: SignMetadataRole | null, @Args('index', { nullable: true }) index?: string | null): Promise<any> {
