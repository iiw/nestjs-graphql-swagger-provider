...
@InputType()
export class PostWalletsWalletIdPaymentFeesInputPayments {
  @Field()
  address!: string;

  @Field(() => PostWalletsWalletIdPaymentFeesInputPaymentsAmount, { description: 'Coins, in Lovelace' })
  amount!: PostWalletsWalletIdPaymentFeesInputPaymentsAmount;
}

@InputType()
export class PostWalletsWalletIdPaymentFeesInputPaymentsAmount {
  @Field(() => Float)
  quantity!: number;

  @Field(() => PostWalletsWalletIdPaymentFeesInputUnit)
  unit!: PostWalletsWalletIdPaymentFeesInputUnit;
}

@InputType()
export class PostWalletsWalletIdPaymentFeesInputTimeToLive {
  @Field(() => Float)
  quantity!: number;
...
@InputType()
export class PostWalletsWalletIdTransactionsInputPayments {
  @Field()
  address!: string;

  @Field(() => PostWalletsWalletIdTransactionsInputPaymentsAmount, { description: 'Coins, in Lovelace' })
  amount!: PostWalletsWalletIdTransactionsInputPaymentsAmount;
}

@InputType()
export class PostWalletsWalletIdTransactionsInputPaymentsAmount {
  @Field(() => Float)
  quantity!: number;

  @Field(() => PostWalletsWalletIdTransactionsInputUnit)
  unit!: PostWalletsWalletIdTransactionsInputUnit;
}

@InputType()
export class PostWalletsWalletIdTransactionsInputTimeToLive {
  @Field(() => Float)
  quantity!: number;
...
export class PostWalletsWalletIdPaymentFeesInput {
  @Field(() => [PostWalletsWalletIdPaymentFeesInputPayments], { description: 'A list of target outputs' })
  payments!: PostWalletsWalletIdPaymentFeesInputPayments[];
...
export class PostWalletsWalletIdTransactionsInput {
  ...
  @Field(() => [PostWalletsWalletIdTransactionsInputPayments], { description: 'A list of target outputs' })
  payments!: PostWalletsWalletIdTransactionsInputPayments[];
  ...
  @Field(() => PostWalletsWalletIdTransactionsInputTimeToLive, { description: 'The TTL (time to live) is the time period in which the transaction\nwill be accepted into node mempools.\n\nAfter the TTL has lapsed, the transaction is considered\nexpired. At this point, nodes will give up on broadcasting the\ntransaction, and the wallet will release the funds allocated to\nthe transaction so they can be used for other payments.\n\nThe TTL should be long enough that the transaction has time to be\npropagated through the network and confirmed, but short enough so\nthat - in the event of failures - UTxO are returned to the wallet\nin a timely manner.\n\nThe TTL value is given in seconds. It will be converted to a slot\nnumber internally.\n\nIf the TTL is not provided for a payment, a reasonable default\nvalue will be used.\n' })
  time_to_live?: PostWalletsWalletIdTransactionsInputTimeToLive;
}
