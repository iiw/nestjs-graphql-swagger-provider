...
export class GetWalletsWalletIdMigrationsResponse {
  @Field({ description: 'Total amount which will be paid as fees for the migration.' })
  migration_cost!: string;

  @Field({ description: 'Leftovers dust coins which won\'t be migrated nor spent as fees.' })
  leftovers!: string;
}
