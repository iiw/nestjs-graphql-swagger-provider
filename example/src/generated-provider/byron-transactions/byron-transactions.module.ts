...
import { ByronTransactionsResolver } from './byron-transactions.resolver';
...
@Module({})
export class ByronTransactionsModule {
  static register(apiClient: Api<unknown>, requestConfigFactory?: RequestConfigFactory): DynamicModule {
        const providers: any[] = [
          ...
          ByronTransactionsResolver,
          ByronTransactionsService,
        ];
        ...
        return {
          module: ByronTransactionsModule,
          providers,
        };
  }
}
