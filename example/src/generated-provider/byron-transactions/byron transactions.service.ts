...
import { PostByron-walletsWalletIdPayment-feesInput, PostByron-walletsWalletIdTransactionsInput } from './byron transactions.dto';
...
export class ByronTransactionsService {
  ...
  async postByronTransactionFee(walletId: string, input: PostByron-walletsWalletIdPayment-feesInput): Promise<any> {
  ...
  async postByronTransaction(walletId: string, input: PostByron-walletsWalletIdTransactionsInput): Promise<any> {
