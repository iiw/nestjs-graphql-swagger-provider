...
import { PostWalletsWalletIdCoin-selectionsRandomInput } from './coin selections.dto';

@Injectable()
export class CoinSelectionsService {
  ...
  async selectCoins(walletId: string, input: PostWalletsWalletIdCoin-selectionsRandomInput): Promise<any> {
