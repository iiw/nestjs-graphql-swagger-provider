...
import { PostByron-walletsInput, PutByron-walletsWalletIdInput, PutByron-walletsWalletIdPassphraseInput } from './byron wallets.dto';
...
export class ByronWalletsService {
  ...
  async postByronWallet(input: PostByron-walletsInput): Promise<any> {
  ...
  async putByronWallet(walletId: string, input: PutByron-walletsWalletIdInput): Promise<any> {
  ...
  async putByronWalletPassphrase(walletId: string, input: PutByron-walletsWalletIdPassphraseInput): Promise<any> {
