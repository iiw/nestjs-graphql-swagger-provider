...
import { PostStake-poolsMaintenance-actionsInput, DeleteStake-pools*WalletsWalletIdInput, PutStake-poolsStakePoolIdWalletsWalletIdInput } from './stake pools.dto';
...
export class StakePoolsService {
  ...
  async postMaintenanceAction(input: PostStake-poolsMaintenance-actionsInput): Promise<any> {
  ...
  async quitStakePool(walletId: string, input: DeleteStake-pools*WalletsWalletIdInput): Promise<any> {
  ...
  async joinStakePool(stakePoolId: string, walletId: string, input: PutStake-poolsStakePoolIdWalletsWalletIdInput): Promise<any> {
