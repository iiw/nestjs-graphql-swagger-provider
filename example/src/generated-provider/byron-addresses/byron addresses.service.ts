...
import { PostByron-walletsWalletIdAddressesInput, PutByron-walletsWalletIdAddressesInput } from './byron addresses.dto';
...
export class ByronAddressesService {
  ...
  async createAddress(walletId: string, input: PostByron-walletsWalletIdAddressesInput): Promise<any> {
  ...
  async importAddresses(walletId: string, input: PutByron-walletsWalletIdAddressesInput): Promise<any> {
